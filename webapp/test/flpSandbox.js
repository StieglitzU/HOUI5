		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atcloudnazhoui505-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atcloudnazhoui505-display": {
								"semanticObject": "atcloudnazhoui505",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.cloudna.zhoui505",
									"url": sap.ui.require.toUrl("at/cloudna/zhoui505")
								}
							}
						}
					}
